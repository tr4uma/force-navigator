 ...
 */
    ...
    function initShortcuts() {
      ...
      MSG.listenFor('Get Settings', function(response) {
    ...
    function init()
    {
        ...
        MSG.sendMessage('Get Commands', {'key': hash});
        MSG.listenFor('Get Commands',
          function(response) {
            cmds = response;
        ...
        MSG.sendMessage('Get Metadata', {'key': hash});
        MSG.listenFor('Get Metadata', function(response) {
            metaData = response;
        });
...
},{"./messaging.js":2,"jquery":3,"mousetrap":4}],2:[function(require,module,exports){
